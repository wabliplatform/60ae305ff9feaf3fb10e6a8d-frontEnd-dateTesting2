...
(function(root, factory) {
  ...
  describe('Project', function() {
    ...
    it('should have the property pdate1 (base name: "pdate1")', function() {
      // uncomment below and update the code to test the property pdate1
      //var instance = new TempApi.Project();
      //expect(instance).to.be();
    });

    it('should have the property pdate2 (base name: "pdate2")', function() {
      // uncomment below and update the code to test the property pdate2
      //var instance = new TempApi.Project();
      //expect(instance).to.be();
    });

    it('should have the property pdate3 (base name: "pdate3")', function() {
      // uncomment below and update the code to test the property pdate3
      //var instance = new TempApi.Project();
      //expect(instance).to.be();
    });
